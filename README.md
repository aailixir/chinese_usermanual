# AI靈丹軟體
本AI標注、訓練、辨識與管理軟體，是基於網路架構的邊緣運算私雲服務，彈性化的架構有利於未來擴展至公雲SaaS端服務。邊緣運算私雲服務能確保使用者的資料集在企業內部，不會有資料外洩的疑慮，公雲服務亦可提供便捷的SaaS端服務。整體系統架構彈性兼顧未來擴充性。
...
## 軟體下載
* **請點選** <a href="https://anno.ailixir.com.tw/downloads" target="_blank">https://anno.ailixir.com.tw/</a>
...
# 第一章: 使用前準備
## 軟體安裝
請下載AI靈丹軟體安裝包，使用雙擊滑鼠執行安裝Ailixir AI靈丹軟體。
...
除了手動更新外，Ailixir 在登錄後的首頁，使用「套件安裝」按鈕可以安裝PyTorch等環境，另可以使用「套件總覽」按鈕來檢視已經安裝的套件。
...
# 第五章 模型訓練
在完成[CUDA安裝後](https://github.com/aailixir/chinese_usermanual/blob/main/images/demo_cuda_ok.jpg)，可以參閱「環境設定套件總覽」。並按下「套件總覽」按鈕，來確定相關套件是否安完成，如下圖代表套件安裝完成。
